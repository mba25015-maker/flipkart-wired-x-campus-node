...
def report():
    ...
    print("  " + "-" * (W - 2))
    print()
    print("  CAN THE BASKET STILL COVER IT?  (basket.py lever, management's stated ceiling)")
    ...
    print()
    print("  >>> READ-OUT. Every priced shock stays inside the basket lever's stated ceiling.")
